...
define ce = Character("Chefe da Empresa de Tecnologia")
define eg = Character("Engenheiro")
define t = Character("Técnico")
define f = Character("Funcionário")
...
# a partir da questão 22 -> SO 2
    ...
    "Depois de algumas semanas como estagiário no Departamento Técnico de Informática, você começa a chamar a atenção pela facilidade em resolver problemas relacionados aos computadores."

    "Seu desempenho desperta o interesse de uma empresa de tecnologia responsável pelo desenvolvimento de sistemas operacionais."

    "Você é convidado para participar de um processo seletivo para integrar a equipe de desenvolvimento do projeto."

    show chefe_empresa

    c "Parabéns por ter aceitado nosso convite."

    c "Meu nome é ... e sou o gerente responsável pelo desenvolvimento do Kernel do nosso sistema operacional."

    c "Nós já sabemos que você possui bons conhecimentos sobre hardware, inicialização do sistema e gerenciamento básico de processos."

    c "Agora precisamos descobrir se você está preparado para trabalhar nas partes internas do sistema operacional."

    c "Durante os próximos testes você irá acompanhar diferentes equipes da empresa."

    c "Cada equipe está enfrentando um problema específico."

    c "Seu objetivo será ajudá-las a corrigir esses problemas para que possamos concluir o desenvolvimento da próxima versão do nosso sistema operacional."

    scene armazenamento

    eg "Ainda bem que você chegou."

    eg "Estamos finalizando o módulo responsável pelo sistema de arquivos."

    eg "Depois da última atualização vários arquivos passaram a ser gravados incorretamente."

    eg "Antes de corrigirmos o código, precisamos verificar se todos da equipe realmente entendem como os métodos de armazenamento funcionam."
    ...
    label indexada2:
        ...
        menu:
            "setores":
                ...
                jump indexada2 
            "níveis":
                "Após responder todas as duvidas, o módulo de armazenamento voltou a funcionar"
                jump contexto
            "registros físicos":
    ...
    label contexto:
        eg "Ótimo... O módulo de arquivos voltou a funcionar, porém, estamos enfrentando um problema mais sério."
        eg "Durante as trocas de processos, alguns programas estão retornando para posições incorretas."
        eg "Me parece que alguma informação importante está deixando de ser salva."
    ...
    label armzprocesso:
        ...
        menu:
            ...
            "memória principal (RAM)":
                "Após corrigir o gerenciamento de processos, os programas voltam a executar normalmente."
                jump mutex
    ...
    label mutex:
        "Você encontra vários engenheiros tentando controlar um tipo de robô dentro da empresa."
        eg "Descobrimos que dois programas estão enviando comandos ao robô exatamente ao mesmo tempo."
        eg "O resultado não foi muito agradável..."
        eg "Precisamos impedir que isso aconteça novamente."
    ...
    label chamada_sistema:
        "Conforme você resolve os problemas, os engenheiros conseguem controlar o robô de forma eficiente e segura."
        "Contudo, outros problemas surgem, exigindo que você continue ajudando a equipe de desenvolvimento do sistema operacional."
        eg "Agora o problema mudou. Alguns programas estão tentando controlar o robô diretamente."
        eg "Se qualquer programa puder acessar o hardware sem autorização... Nosso sistema operacional perde completamente o controle."
    ...
    label interrupcao:
        t "Instalamos uma nova placa no computador... Mas o sistema operacional não consegue conversar com ela." 
    ...
    label atomicidade:
        "Em uma sala cheia de monitores, você se depara com um outro engenheiro"
        eg "Estamos testando o escalonador. Alguns programas importantes precisam receber prioridade."
    ...
    label condicao_corrida:
        "A sala então fica toda vermelha. Um alarme começa a tocar."
        "Um funcionário entra correndo e diz: "
        f "Temos um bloqueio. Na verdade... Temos vários."
    ...
    label comparacao:
        "As luzes da sala voltam ao normal."
        scene memoria 
        ce "Excelente trabalho. Todos os módulos principais já estão funcionando."
        ce "Falta apenas revisar a Unidade de Gerência de Memória."
        ce "Ela é responsável por garantir que cada processo enxergue apenas a memória que lhe pertence."
    ...
    "A nova versão do sistema operacional foi compilada com sucesso."
    "Todos os testes passaram."
    show chefe_empresa
    ce "Parabéns."
    ce "Você ajudou todas as equipes da empresa a concluir o desenvolvimento do nosso sistema operacional."
    ce "Seu estágio termina hoje..."
    ce "...mas gostaríamos que você permanecesse conosco como desenvolvedor."