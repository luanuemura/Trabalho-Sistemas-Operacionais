...
# a partir da questão 22 -> SO 2
    ...
    label chamada_sistema:
        "Para evitar que um processo egoísta cause um monopólio, o braço robótico agora é gerenciado pelo Sistema Operacional. Sempre que um processo de usuário precisa mover o braço, ele deve solicitar essa operação através de uma _________."
        menu:
            "variável global":
